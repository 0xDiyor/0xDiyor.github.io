...
- No frameworks, no build tools, no dependencies beyond `marked.js` for rendering markdown
- Dark terminal aesthetic because that's what feels right

## Get in Touch

Find me on [GitHub](https://github.com/0xDiyor) or connect on LinkedIn. If you spot something wrong in a writeup or want to talk shop, reach out.
